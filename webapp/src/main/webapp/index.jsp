...
<<<<<<< HEAD
  <a class="navbar-brand" href="#">Laboratory Information Management System</a>
...
>>>>>>> 7a8c8befc2bce49c0d86639674718c063995caa1
      ...
      <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">Lab Admin</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item" href="#">Help File</a>
            </div>
          </li>
        </ul>
